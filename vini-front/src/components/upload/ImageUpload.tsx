  ...
  return (
    <section className="border border-gray-200 bg-white">
      <div className="px-5 py-3 border-b border-gray-100">
        <h2 className="text-sm font-bold uppercase tracking-widest text-gray-700">Fotot</h2>
      </div>
      <div className="px-5 py-4 space-y-4">
        <p className="text-sm text-gray-500">
          Shto deri në 5 foto. Foto të qarta nga disa kënde e shesin pjesën më shpejt.
        </p>
        {imageFiles.length < 5 && (
